...
<head>
    <head>
        ...
        <!-- SLEEK CSS -->
        <link id="sleek-css" rel="stylesheet" href="{{ asset('backend/assets/css/sleek.cs') }}s" />
...
<div class="container d-flex flex-column justify-content-between vh-100">
                ...
                <div class="card-header bg-primary">
                    <div class="app-brand">
                        <a href="/index.html">
                            ...
                            <span class="brand-name">Laravel App</span>
                        </a>
                    </div>
                </div>
    ...
    <div class="copyright pl-0">
        <p class="text-center">&copy; 2021 Copyright Easy Dashboard
            <a class="text-primary" href="http://www.iamabdus.com/" target="_blank">Zaïb</a>.
        </p>
    </div>
</div>
</body>
